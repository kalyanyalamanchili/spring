...
/**
 * SpringBoot Application for computing if given list of cities are connected.
 * 
 */
@SpringBootApplication
@RestController
@EnableSwagger2
@Api(value = "Pathfinder demo application", description = "Find if a path exists between two cities")
public class PathfinderApplication {
    ...
    public String isConnected(
        ...
        return String.valueOf(Commuter.commute(originCity, destCity)).equals("true") ? "yes" : "no";
    }
    ...
    public String info() {
        ...
        html.append("<!DOCTYPE html><head><meta charset=\"utf-8\"><title>City Data</title></head><body>")
                .append("<h2>Path finder app: Cities list</h2>")
                .append("<ul>");
        
        System.out.print("CITIES LIST: " + "\n");
        
        Collection<City> cities = county.getCityMap().values();
        for (City city : cities) {
            System.out.print("" + city.getName() + "-->" + city.prettyPrint() + "\n");
        }
